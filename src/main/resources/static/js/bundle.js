...
/***/ function(module, exports, __webpack_require__) {
	...
	var _throttle = __webpack_require__(107);

	var _throttle2 = _interopRequireDefault(_throttle);

	var _google = __webpack_require__(115);
	...
	function initMap() {
	    var _parse = (0, _queryString.parse)(window.location.search);

	    var lat = _parse.lat;
	    var long = _parse.long;
	    ...
	    var map = new _google2.default.maps.Map(document.getElementById('map'), {
	        center: center,
	        zoom: 16,
	        minZoom: 15,
	        maxZoom: 18
	    ...
	    map.data.setStyle({
	        icon: {
	            ...
	            anchor: new _google2.default.maps.Point(11, 11)
	        }
	    });
	    map.data.addListener('click', addLure);

	    _google2.default.maps.event.addListener(map, 'bounds_changed', (0, _throttle2.default)(findMarkers, 1000));
	    ...
	    function onPositionFound(position) {
	        map.setCenter(new _google2.default.maps.LatLng(position.coords.latitude, position.coords.longitude));
	    ...
	    function findMarkers(event) {
	        ...
	        fetch('/lures?neLat=' + ne.lat() + '&neLong=' + ne.lng() + '&swLat=' + sw.lat() + '&swLong=' + sw.lng()).then(function (resp) {
	            return resp.json();
	        }).then(function (json) {
	            return json.lures;
	        }).then(function (lures) {
	    ...
	    function marker(lure) {
	        var location = new _google2.default.maps.LatLng(lure.latitude, lure.longitude);
	    ...
	    function placeMarker(location, expiresAt) {
	        new _google2.default.maps.Marker({
	            position: location,
	            map: map
	        });

	        new MapLabel({
	            text: (0, _moment2.default)(expiresAt).format('HH:mm'),
	            position: location,
	            map: map,
	            fontSize: 20
	        });
